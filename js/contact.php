...
$subject ="Новая заявка с сайта vladma3p.beget.tech";
...
$header .= "From: Новая заявка <vladmajstruc@gmail.com>\n\n";	
$mail = mail("vladmajstruc@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
